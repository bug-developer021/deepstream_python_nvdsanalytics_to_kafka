...
generate_analytics_module_object (void *privData, NvDsEventMsgMeta *meta)
{
  ...
  json_object_set_double_member (analyticsObj, "stream_source_id", meta->source_id);
  json_object_set_double_member (analyticsObj, "lc_curr_straight", meta->lc_curr_straight);
  json_object_set_double_member (analyticsObj, "lc_curr_left", meta->lc_curr_left);
  json_object_set_double_member (analyticsObj, "lc_curr_right", meta->lc_curr_right);
  json_object_set_double_member (analyticsObj, "lc_cum_straight", meta->lc_cum_straight);
  json_object_set_double_member (analyticsObj, "lc_cum_left", meta->lc_cum_left);
  json_object_set_double_member (analyticsObj, "lc_cum_right", meta->lc_cum_right);
  return analyticsObj;
}
